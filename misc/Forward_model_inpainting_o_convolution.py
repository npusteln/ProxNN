...
# %%
"""
Define linear operator : Inpainting o Convolution
---------------------------------------------------------
...
# Inpainting forward model
filter_0 = dinv.physics.blur.gaussian_blur(sigma=(2, 0.1), angle=0.0)
physics1 = dinv.physics.Blur(filter_0, device=device, padding='reflect')

physics2 = dinv.physics.Inpainting(
