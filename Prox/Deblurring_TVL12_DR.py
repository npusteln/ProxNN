...
"""
Reconstruction TV-isotropic with Douglas-Rachford algorithm
-----------------------------------------------------------
"""
...
for k in range(param_iter):
  ...
  x_prev = xk.clone()
  xk = data_fidelity.prox(yk,y,physics, gamma=param_gamma)
  vk  = prior.prox(2*xk-yk,gamma=param_gamma*param_regul)
  yk  = yk - xk + vk
